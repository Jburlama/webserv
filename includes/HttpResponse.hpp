...
class HttpResponse
{
    ...
    public:
        ...
        ssize_t                  get_upload_lenght()    {return this->_upload_length;};
        ...
        std::string              get_response_location(){return this->_response_location;};
        ...
        void set_response_location(std::string location){this->_response_location = location;};
        ...
        void set_upload_length(size_t size)             {this->_upload_length = size;};
};
